...
* 🌿 **Potato Disease Classification** – CNN + TensorFlow + FastAPI + Render
* 🏠 **Real Estate Price Prediction System** – Regression + scikit-learn + Flask + Pandas
* 🏅 **Sports Celebrity Image Classification** – OpenCV + Machine Learning + Image Processing
* 📊 **ML Pipelines & Experiments** – scikit-learn + XGBoost + Feature Engineering + Model Evaluation
